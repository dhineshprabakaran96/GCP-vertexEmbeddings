...
# def formatPrompt(res):
#   header= """Format the following steps in separate lines:"
  ...
  if validation != True : ##<----   *****
    ...
    if data['resource'] == "messages" and data['event'] == "created":
      ...
      # Process incoming feedback and upload to Bigquery using session ID
        get_followup(message_id, room_id, sender_email, conversation_ID, data['data']['created'])   
