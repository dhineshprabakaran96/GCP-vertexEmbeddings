module "cloud_run" {
  ...
  service_name          = "cmsa-chatbot-api"      # The name of the cloud run service"
  service_image_url     = "us-central1-docker.pkg.dev/ford-4360b648e7193d62719765c7/ford-container-images/genapp-bot-new:4.0"
  ...
  environment = [ # List of environment variables to set in the container.
    ...
    
    {
      ...
      value = "NjljNGJhMGItYzk3MC00OGQ5LWEzNTAtNjk0NTJjNWNlMTA0NDEzYzIzMTUtZTYw_PF84_af742d39-7515-46a3-82a7-03269e091b"
    },
    {
      name  = "APIGEE_BOT_ACCESS_TOKEN" 
      value = "YWEyZTQ4NDMtYTMwMS00NzRjLTgwZDYtYjVjNGRkNGEyYjQ4OTY5N2NhYjYtYzEz_PF84_af742d39-7515-46a3-82a7-03269e091b91"
    },
    {
      name  = "TEKTON_BOT_ACCESS_TOKEN" 
      value = "OTBhZTZjN2QtNDgwYi00MWQzLWJlNmUtZDRmMGRkZGM1MjNhMGMyNjJlYjktNTMw_PF84_af742d39-7515-46a3-82a7-03269e091b91"
    },
    {
      name = "INTEGRATION_ACCESS_TOKEN"
      value = "ZmVlZWY3ODgtOGQ5OC00NWIzLTgzNGUtNTE1YWRlZTNkZjAxYjQ3YWY1NTctMWRh_PF84_af742d39-7515-46a3-82a7-03269e091b91"
    },
    {
      name  = "ORG_ID" 
