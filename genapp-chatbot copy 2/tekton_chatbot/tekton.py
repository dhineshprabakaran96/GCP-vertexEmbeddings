...
TEKTON_BOT_ACCESS_TOKEN = os.environ["BOT_ACCESS_TOKEN"]
...
def process_message(question):
  ...
  url=f"https://discoveryengine.googleapis.com/v1alpha/projects/655678175973/locations/global/collections/default_collection/dataStores/tekton-chatbot-datastore_1707543336032/conversations/-:converse"
...
def get_conversation_id(room_id):
  ...
  if room_id in conversation_ids:
      ...
      url=f"https://discoveryengine.googleapis.com/v1alpha/projects/655678175973/locations/global/collections/default_collection/dataStores/tekton-chatbot-datastore_1707543336032/conversations"
