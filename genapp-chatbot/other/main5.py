...
#get_followup response from GenAPp
  ...
  logging.info("This is the prompt:" + prompt) ##
...
def handle_webhook():
  ...
  if 'orgId' in data:
  ...
  elif "question" in data and data.get("follow-up") == False:
  ...
  elif  "question" in data and data.get("follow-up") == True:
    ...
    followup_response = get_followup_web(question, conversation_ID)
    # return send_message_web(question, response_json, format_response, suggested_list)
