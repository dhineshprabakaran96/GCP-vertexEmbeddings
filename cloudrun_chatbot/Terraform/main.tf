module "cloud_run" {
  ...
  service_name          = "cloudrun-chatbot"      # The name of the cloud run service"
  service_image_url     = "us-central1-docker.pkg.dev/ford-4360b648e7193d62719765c7/ford-container-images/cloudrun-chatbot:1.0"
  ...
  environment = [ # List of environment variables to set in the container.
    ...
    
    {
      ...
      value = "ZDBlYTEyMTgtN2I1MS00MmRjLWE5N2EtNDg2MzhhMTVkMjU2ZWU5ODlmODAtOTcy_PF84_af742d39-7515-46a3-82a7-03269e091b91"
    },
    {
      name = "INTEGRATION_ACCESS_TOKEN"
      value = "MjE1NmVjOWYtZTkxOC00YWQ2LWI5OTAtNWZiYWE0NmMxMjE4ZmY3ZDBmOTctNzlh_PF84_af742d39-7515-46a3-82a7-03269e091b91"
    },
    {
      name  = "ORG_ID" 
